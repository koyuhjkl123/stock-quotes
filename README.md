...
* 이메일 인증 구현시 구글 메일은 2차 앱 비밀번호 설정 보안 관리가 중요!
* 콘솔 간격 버그는 아무리 해도 안된다
* 거래량과 시가총액 금액 단위를 if문 및 for문 사용하여 포맷팅 할 시 침착하게 사용하자
* 자바에서 지원되는 다양한 클래스 및 인터페이스를 사용하여 새로운 사실을 알게 됨
