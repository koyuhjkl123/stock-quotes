...
public class TradedbTest {
	...
	public TradedbTest(int id, String countryid, String name, long year, String imgoods, String exgoods, long income,
			long expense) {
		this.id = id;
...
//	}
	...
	public static void main(String[] args) throws Exception {
		TradedbTest tt = new TradedbTest();
